...
void ModSample::Convert(MODTYPE fromType, MODTYPE toType)
{
	...
	if(((fromType & MOD_TYPE_XM) && (toType & (MOD_TYPE_IT | MOD_TYPE_MPT | MOD_TYPE_LSH))) || ((toType & MOD_TYPE_XM) && (fromType & (MOD_TYPE_IT | MOD_TYPE_MPT | MOD_TYPE_LSH))))
	{
	...
	if(!(toType & (MOD_TYPE_MPT | MOD_TYPE_LSH)))
	{

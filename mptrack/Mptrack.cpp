...
BEGIN_MESSAGE_MAP(CTrackApp, CWinApp)
	...
	ON_COMMAND(ID_NEW_LSH,		&CTrackApp::OnFileNewLSH)
...
void CTrackApp::OpenModulesDialog(std::vector<mpt::PathString> &files, const mpt::PathString &overridePath)
{
	...
	static constexpr std::string_view commonExts[] = {"mod", "s3m", "xm", "it", "mptm", "mo3", "oxm", "nst", "stk", "m15", "pt36", "mid", "rmi", "smf", "wav", "mdz", "s3z", "xmz", "itz", "mdr", "lptm"};
